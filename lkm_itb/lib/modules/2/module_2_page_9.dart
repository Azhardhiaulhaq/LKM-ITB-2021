...
class Modul2Page9 extends StatefulWidget {
  ...
  final String role;
  static const routeName = '/module/2/page/9';
  int module = 2;
  int page = 9;
  String? menteeID;

  @override
  _Modul2Page9State createState() =>
      _Modul2Page9State(role, module, page, menteeID);
}

class _Modul2Page9State extends State<Modul2Page9> {
  final String role;
  final int module;
  final int page;
  String? menteeID;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _image('assets/images/modul_2_9_1.png'),
          SizedBox(
            height: 20,
          ),
          Text(
          ...
          _image('assets/images/modul_2_9_2.png'),
          SizedBox(
            height: 20,
          ),
          Text(
