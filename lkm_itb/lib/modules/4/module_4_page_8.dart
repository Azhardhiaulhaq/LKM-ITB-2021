...
class Modul4Page8 extends StatefulWidget {
  Modul4Page8({Key? key, required this.role, this.menteeID}) : super(key: key);

  final String role;
  static const routeName = '/module/4/page/8';
  int module = 4;
  int page = 8;
  String? menteeID;

  @override
  _Modul4Page8State createState() =>
      _Modul4Page8State(role, module, page, menteeID);
}

class _Modul4Page8State extends State<Modul4Page8> {
  final String role;
  final int module;
  final int page;
  String? menteeID;
  ...
  _Modul4Page8State(this.role, this.module, this.page, this.menteeID);
      ...
      child: Column(
        ...
        children: [
          ...
          new ModuleAnswerField(
              title:
                  'Setelah belajar tentang arti agile, yuk berikan atau ceritakan contoh agile yang kamu lakukan baik dalam kuliahmu, aktivitasmu di rumah atau di organisasimu!',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Setelah belajar tentang arti agile, ajak Mentee untuk memberikan atau menceritakan contoh agile yang kamu lakukan baik dalam kuliah, aktivitas di rumah atau di organisasinya.Setelah belajar tentang arti agile, ajak Mentee untuk memberikan atau menceritakan contoh agile yang kamu lakukan baik dalam kuliah, aktivitas di rumah atau di organisasinya.',
      ...
      children: [
        ...
        Positioned(
            ...
            child: new CustomModuleButton(
                pushFunction: () => pushFunction('/module/4/page/9', context))),
      ],
    ));
  }
