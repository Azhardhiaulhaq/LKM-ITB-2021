...
class Modul3Page20 extends StatefulWidget {
  ...
  final String role;
  static const routeName = '/module/3/page/20';
  int module = 3;
  int page = 20;
  String? menteeID;

  @override
  _Modul3Page20State createState() =>
      _Modul3Page20State(role, module, page, menteeID);
}

class _Modul3Page20State extends State<Modul3Page20> {
  final String role;
  final int module;
  final int page;
  String? menteeID;
      ...
      child: Column(
        ...
        children: [
          ...
          new ModuleAnswerField(
              title:
                  'Dari kedua gambar tersebut, kira kira hubungan apa yang didapatkan?',
  ...
  _forMentor() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Minta Mentee untuk menganalisis hubungan kedua gambar berikut!',
            style: GoogleFonts.roboto(
              fontSize: 14,
              color: ConstColor.blackText,
              fontWeight: FontWeight.w400,
