...
class Modul3Page4 extends StatefulWidget {
  Modul3Page4({Key? key, required this.role, this.menteeID}) : super(key: key);

  final String role;
  static const routeName = '/module/3/page/4';
  int module = 3;
  int page = 4;
  String? menteeID;

  @override
  _Modul3Page4State createState() =>
      _Modul3Page4State(role, module, page, menteeID);
}

class _Modul3Page4State extends State<Modul3Page4> {
  final String role;
  final int module;
  final int page;
  String? menteeID;
  ...
  _Modul3Page4State(this.role, this.module, this.page, this.menteeID);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Yuk coba pertanggungjawabkan aktivitasmu, mengapa kamu melakukan hal tersebut!',
            style:
                GoogleFonts.roboto(fontSize: 14, color: ConstColor.blackText),
            textAlign: TextAlign.justify,
          ),

          for (var i = 0; i < 7; i++) _answerField(i),
          menteeID != null
  ...
  _answerField(int index) {
    return Column(
      ...
      children: [
        ...
        Text('Alasan Aktivitas ' + (index+1).toString(),
            style:
  ...
  _forMentor() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Minta Mentee untuk mengisi relasi aktivitas satu pekan kemarin dengan tanggungjawabnya masing-masing!',
      ...
      children: [
        ...
        Positioned(
            ...
            child: new CustomModuleButton(
                pushFunction: () => pushFunction('/module/3/page/5'))),
      ],
    ));
  }
