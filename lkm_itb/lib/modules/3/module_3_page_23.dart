...
class Modul3Page23 extends StatefulWidget {
  Modul3Page23({Key? key, required this.role, this.menteeID}) : super(key: key);

  final String role;
  static const routeName = '/module/3/page/23';
  int module = 3;
  int page = 23;
  String? menteeID;

  @override
  _Modul3Page23State createState() =>
      _Modul3Page23State(role, module, page, menteeID);
}

class _Modul3Page23State extends State<Modul3Page23> {
  final String role;
  final int module;
  final int page;
  String? menteeID;
  ...
  _Modul3Page23State(this.role, this.module, this.page, this.menteeID);
      ...
      if (menteeID != null) {
        ...
        await ModuleRepository.initiateModuleGrades(
          ...
          await ModuleRepository.addModuleGrades(module.toString(),
              ...
              .then((value) {
            Navigator.pushNamed(context, Modul3Page25.routeName,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Sudah sering melihat gambar seperti ini bukan?',
          ...
          new ModuleAnswerField(
              title:
                  'Menurutmu, hikmah apa yang dapat diambil dari gambar tersebut?',
  ...
  _forMentor() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Minta Mentee untuk melihat gambar berikut dan minta mereka kemukakan pendapatnya!',
            style: GoogleFonts.roboto(
              fontSize: 14,
              color: ConstColor.blackText,
              fontWeight: FontWeight.w400,
      ...
      children: [
        ...
        Positioned(
            ...
            child: new CustomModuleButton(
                pushFunction: () => pushFunction('/module/3/page/24', context))),
