...
class Modul3Page30 extends StatefulWidget {
  ...
  final String role;
  static const routeName = '/module/3/page/30';
  int module = 3;
  int page = 30;
  String? menteeID;

  @override
  _Modul3Page30State createState() =>
      _Modul3Page30State(role, module, page, menteeID);
}

class _Modul3Page30State extends State<Modul3Page30> {
  final String role;
  final int module;
  final int page;
  String? menteeID;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Nah, sekarang ketika kamu bekerja dalam tekanan, kira kira hal apa atau apa yang kamu lakukan untuk bangkit kembali ketika sudah masuk kedalam kondisi fatigue?',
            style:
  ...
  _forMentor() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Minta Mentee menjawab pertanyaan yang tertera, apa cara yang biasa mereka lakukan untuk mengembalikan diri dari kondisi kelelahan!',
