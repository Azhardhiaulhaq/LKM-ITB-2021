...
class Modul5Page3 extends StatefulWidget {
  Modul5Page3({Key? key, required this.role, this.menteeID}) : super(key: key);

  final String role;
  static const routeName = '/module/5/page/3';
  int module = 5;
  int page = 3;
  String? menteeID;

  @override
  _Modul5Page3State createState() =>
      _Modul5Page3State(role, module, page, menteeID);
}

class _Modul5Page3State extends State<Modul5Page3> {
  final String role;
  final int module;
  final int page;
  String? menteeID;
  ...
  String youtube_link = 'https://www.youtube.com/watch?v=_03OeZU2tfs';
  late YoutubePlayerController _youtubeController;

  _Modul5Page3State(this.role, this.module, this.page, this.menteeID);
      ...
      if (menteeID != null) {
        ...
        await ModuleRepository.initiateModuleGrades(
          ...
          await ModuleRepository.addModuleGrades(module.toString(),
              ...
              .then((value) {
            Navigator.pushNamed(context, Modul5Page4.routeName,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Minta Mentee untuk menonton video berikut kemudian menjawab pertanyaan yang tertera!',
          ...
          Container(
              margin: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
              child: Text(
                'Sumber : Hipotesa Youtube Channel',
                style: GoogleFonts.roboto(
                  fontSize: 14,
                  color: ConstColor.blackText,
                  fontWeight: FontWeight.w400,
          ...
          new ModuleAnswerField(
              title:
                  'Dari video tersebut, apakah arti dari kata nasionalisme?',
      ...
      children: [
        ...
        Positioned(
            ...
            child: new CustomModuleButton(
                pushFunction: () =>
                    pushFunction('/module/5/page/4', context))),
      ],
    ));
  }
