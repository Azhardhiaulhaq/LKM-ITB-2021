...
class Modul5Page11 extends StatefulWidget {
  Modul5Page11({Key? key, required this.role}) : super(key: key);

  final String role;
  static const routeName = '/module/5/page/11';

  @override
  _Modul5Page11State createState() => _Modul5Page11State(role);
}

class _Modul5Page11State extends State<Modul5Page11> {
  final String role;

  _Modul5Page11State(this.role);
