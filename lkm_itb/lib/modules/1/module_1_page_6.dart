                  ...
                  onPressed: () async {
                    if (role == 'mentee') {
                      ...
                      if (menteeID != null) {
                        ...
                        await ModuleRepository.addModuleGrades("1", "6",
                                listGrades, menteeID!, sharedPrefs.group)
                            .then((value) => Navigator.pushNamed(
                                context, Modul1Page7.routeName,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 30),
          Text(
            'Coba liat gambar tersebut! BERBEDA bukan? Nah, setelah melihat gambar ini, menurut kalian, apa sih pemikiran holistik itu?',
    ...
    return Scaffold(
      ...
      child: Stack(
          ...
          children: <Widget>[
            ...
            Positioned(bottom: 70, child: _Button('/module/1/page/7')),
            isLoading
                ? Center(
                    child: Container(
                        height: 100,
